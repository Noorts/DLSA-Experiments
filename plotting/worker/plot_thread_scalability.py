...
ax.plot(s1, t_rust_L_efficiency, label=f"Large", marker='o', linestyle='-')
...
# plt.plot(s, n_statistic_normalized, label=f"Large", marker='o', linestyle='-')
...
fig.tight_layout()
fig.savefig(os.path.join(FIGURE_DIR, "strong_scalability_percentage_threads.pdf"))
plt.show()
