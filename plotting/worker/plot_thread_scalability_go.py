...
with plt.style.context(["../resources/vu.mplstyle", "../resources/twocolumn.mplstyle"]):
  ...
  plt.plot(s1, t_L_efficiency, color=colors[3], label=f"Large", marker='o', linestyle='-')
  ...
  plt.tight_layout()
  plt.savefig("./strong_scalability_percentage_threads_go.png")
